...
import 'package:jjm_wqmis/views/ftk_data/screens/esr_water_widget.dart';
import 'package:jjm_wqmis/views/ftk_data/screens/handpump_water_widget.dart';
import 'package:jjm_wqmis/views/ftk_data/screens/household_water_widget.dart';
import 'package:jjm_wqmis/views/ftk_data/screens/source_scheme_widget.dart';
...
class AppRoutes {
  static Map<String, WidgetBuilder> getRoutes() {
    return {
      ...
      //tabschoolaganwadi
      AppConstants.navigateToAnganwadiScreen: (context) =>
          const AnganwadiScreen(),
      ...
      //dwsm
      AppConstants.navigateToDwsmDashboard: (context) =>
          const Dwsdashboardscreen(),
      AppConstants.navigateToDwsmLocaitonScreen: (context) =>
          const DwsmLocation(),
      //lab
      AppConstants.navigateLabView: (context) => const AsPerLabTabView(),
      AppConstants.navigateToParameterView: (context) =>
          const Asperparameterview(),
      AppConstants.navigateToLabParam: (context) => const Labparameterscreen(),
      AppConstants.navigateToWTPLab: (context) => const Wtplabscreen(),

      //ftk
      AppConstants.navigateToFtkSampleScreen: (context) =>
          const Ftkmenudashboardscreen(),
      AppConstants.navigateToFtkDashboard: (context) => const ftkDashboard(),
      AppConstants.navigateToFtkSampleListScreen: (context) =>
          const FtkSampleListScreen(),
      //webview
      ...
      AppConstants.navigateToLocationScreen: (context) => const Locationscreen(
            flag: '',
            flagFloating: '',
          ),
      AppConstants.navigateToSampleInformationScreen: (context) =>
          const Sampleinformationscreen(),
      AppConstants.navigateToSampleListScreen: (context) =>
          const SampleListScreen(),
      AppConstants.navigateToSubmitSampleScreen: (context) =>
          const SubmitSampleScreen(),
      AppConstants.navigateToftkSampleInfoScreen: (context) =>
          const ftkSampleInformationScreen(),
      AppConstants.navigateToftkSourceofScheme: (context) =>
          const SourceOfSchemeWidget(),
      AppConstants.navigateToftkStorageESR: (context) => const EsrWaterWidget(),
      AppConstants.navigateToftkHouseHold: (context) =>
          const HouseholdWaterWidget(),
      AppConstants.navigateToftkHandpump: (context) =>
