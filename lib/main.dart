...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (navigatorKey.currentContext != null) {
        _updateViewModel = Provider.of<UpdateViewModel>(
  ...
  Future<void> _checkForUpdate({required bool forceCheck}) async {
    ...
    final isAvailable = await _updateViewModel!
        .checkForUpdateWithThrottle(forceCheck: forceCheck);
    ...
    if (isAvailable && navigatorKey.currentContext != null && mounted) {
      ...
      if (updateInfo != null && !_updateViewModel!.isDialogShown) {
        ...
        await DialogUtils.showUpdateDialog(
            navigatorKey.currentContext!, updateInfo);
