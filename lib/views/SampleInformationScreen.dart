                                      ...
                                      Padding(
                                        ...
                                        child: DropdownButtonFormField<String>(
                                          ...
                                          items: masterProvider.states
                                              .map((state) {
                                            print(
                                                'master provider in the calll $state');
                                      ...
                                      Padding(
                                          ...
                                          child: CustomDropdown(
                                              value: masterProvider
                                                  .selectedDistrictId,
                                              items: masterProvider.districts
                                                  .map((district) {
                                                return DropdownMenuItem<String>(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      CustomDropdown(
                                        ...
                                        items:
                                            masterProvider.blocks.map((block) {
                                          return DropdownMenuItem<String>(
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      ...
                                      DateTime? pickedDate =
                                        ...
                                        lastDate: DateTime
                                            .now(), // Disallow future dates
                                      );

                                      if (pickedDate != null) {
                                        // Check if the selected date is today
                                        bool isToday = pickedDate
