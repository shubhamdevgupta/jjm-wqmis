...
import '../models/ParamLabResponse.dart';
        ...
        builder: (context, provider, child) {
          return Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: Stack(
                children: [
                  // Background image that fills the available height dynamically
                  Positioned.fill(
                    child: Image.asset(
                  ...
                  // The actual content with padding to avoid sticking to edges
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Column(
                      children: [
                        // This is your Scaffold’s AppBar and other content
                        Scaffold(
