...
class _LabParameterScreen extends State<Labparameterscreen>  with SingleTickerProviderStateMixin{
  late Masterprovider masterProvider;
          ...
          return Container(
            ...
            child: DefaultTabController(
              ...
              child: Scaffold(
                ...
                backgroundColor: Colors.transparent,
                appBar: AppBar(
                  title: Text('Select Lab/Parameter', style: TextStyle(color: Colors.white)),
                  ...
                  bottom: TabBar(
                    ...
                    tabs: [
                      _buildTab(Icons.science, "As per laboratory"),
                      _buildTab(Icons.list, "As per parameters"),
                    ],
                  ),
                ),
                body: TabBarView(
                  ...
                  children: [
                    _isLoading
                        ...
                        :    _buildAsperlaboratary(context, provider, masterProvider),
                    Center(child: Text('Fetching Parameters...', style: TextStyle(fontSize: 20))),
                  ],
                ),
  ...
  Widget _buildAsperlaboratary(BuildContext context, ParameterProvider provider, Masterprovider masterProvider){
