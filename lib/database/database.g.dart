...
class _$HabitationDao extends HabitationDao {
  _$HabitationDao(
    ...
    this.changeListener,
        ...
        _habitationInsertionAdapter = InsertionAdapter(
            database,
            'Habitation',
            (Habitation item) => <String, Object?>{
  ...
  final InsertionAdapter<Habitation> _habitationInsertionAdapter;

  @override
  Future<List<Habitation>> getAll() async {
    return _queryAdapter.queryList('SELECT * FROM Habitation',
        mapper: (Map<String, Object?> row) => Habitation(
  ...
  @override
  Future<void> insertHabitation(Habitation habitation) async {
    await _habitationInsertionAdapter.insert(
        habitation, OnConflictStrategy.abort);
  }

  @override
  Future<void> insertAll(List<Habitation> habitations) async {
    await _habitationInsertionAdapter.insertList(
        habitations, OnConflictStrategy.abort);
  }
}
